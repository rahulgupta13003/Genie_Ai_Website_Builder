...
import logo5 from '../assets/company-logo-5.svg';
   ...
   const onSubmitHandler = async (e: React.FormEvent) => {
    ...
    try {
      if(!session?.user) {
        ...
        return toast.error('Please enter a valid messege')
      }
      setLoading(true)
  ...
  return (
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <div className="flex flex-wrap items-center justify-center gap-16 md:gap-20 mx-auto mt-16">
          <img src={logo1} alt="Company 1" className="w-28 md:w-32 logo-animate" loading="lazy" />
          <img src={logo2} alt="Company 2" className="w-28 md:w-32 logo-animate" loading="lazy" />
          <img src={logo3} alt="Company 3" className="w-28 md:w-32 logo-animate" loading="lazy" />
          <img src={logo4} alt="Company 4" className="w-28 md:w-32 logo-animate" loading="lazy" />
          <img src={logo5} alt="Company 5" className="w-28 md:w-32 logo-animate" loading="lazy" />
        </div>
