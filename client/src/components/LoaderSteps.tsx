...
const steps = [
    ...
    {icon: SquareIcon, label: "Generating code snippets"},
    {icon: TriangleIcon, label: "Compiling your project"},
    {icon: CircleIcon, label: "Finalizing your website"},
]
    
const STEP_DURATION = 45000 // Duration for each step in milliseconds
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
        ...
        <div className="relative z-10 w-32 h-32 flex items-center justify-center">
            ...
            <div className="absolute inset-6 rounded-full border-4 border-indigo-500 animate-spin"/>
